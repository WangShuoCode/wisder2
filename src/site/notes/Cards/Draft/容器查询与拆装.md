...
<!-- 宽度800像素，高度600像素（常用尺寸，可根据需求调整） --> <iframe src="https://s.apifox.cn/7ea8f2b5-6e04-442e-ad8a-c30994c1079c/api-342504409" width="800" <!-- 宽度：数值+px（可省略单位，默认是px） --> height="1600" <!-- 高度：数值+px（可省略单位，默认是px） --> frameborder="0" <!-- 可选：去掉iframe默认的边框（美观） --> scrolling="auto" <!-- 可选：内容超出时自动显示滚动条（默认值，无需手动加） --> ></iframe>